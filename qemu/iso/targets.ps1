# ==============================================================================
# CASTLE INFRASTRUCTURE: MULTI-MATRIX DEFINITIONS MANIFEST
# ==============================================================================
...
$IsoMatrix = @(
    @{
        ...
        HashUrl   = "https://iso.cachyos.org/desktop/260426/cachyos-desktop-linux-260426.iso.sha256" # Handled via SHA module fallback
    ...
    @{
        ...
        HashUrl   = "https://mirror.gigenet.com/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso.sha512sum"
        SigUrl    = "https://mirror.gigenet.com/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso.sig"
        GpgKey    = "CDF595A1"
