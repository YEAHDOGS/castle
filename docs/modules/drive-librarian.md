...
**Drive Librarian.** user's problem (2026-09-09): ~100 flash drives and
...
dashboard until user tags or enrolls them. See security notes below.
...
- **User tags** in the Librarian DB: `tax-2019`, `mom-photos`, `spare-blank`,
  whatever user wants. Multiple tags per drive, searchable.
...
- Unknown drives are never auto-mounted with exec permissions and never
  auto-backed-up. Sighting logged, dashboard flag raised, user decides.
