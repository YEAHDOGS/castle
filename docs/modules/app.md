...
**Castle App.** user's big picture (2026-09-09): a mobile (iOS + Android)
...
## The sharing strategy (user's rule: all code is a liability)
...
## Remote access: Tailscale-first (user 2026-09-09)
...
- The app is not a file-sync client (that's a separate sync engine if
  user wants Dropbox-style sync later).
