...
**Kennel.** Name confirmed by user (2026-09-09). Old Android phones go in
...
user's use case (2026-09-09): keep Legends of Idleon running 24/7 on a
...
- **Remote access:** WireGuard into Castle, then scrcpy/adb to any kenneled
  phone. From user's laptop or phone, anywhere on Earth, it feels like
...
## Clone Wars integration (user 2026-09-09)
