...
user's directive (2026-09-09): encryption at rest is great in theory, but in
...
fire/theft, AND user's own mistakes, without ever losing data or locking
...
- Long-term vision: Castle warehouse facilities (user's plan) — encrypted
